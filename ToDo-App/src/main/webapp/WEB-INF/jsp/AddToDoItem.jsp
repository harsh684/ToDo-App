...
<body>
    ...
    <div class="container">
		...
		<!-- modeAttribute="todo" object will save all the info put inside inputs from the user and will be passed
		to saveToDoItem function which is mapped with post method -->
        <form:form action="/saveToDoItem" method="post" modelAttribute="todo">
            ...
            <div class="row">
            	<div class="form-group col-md-12">
            		...
            		<div class="col-md-6">
            		<!-- path="title" means mapping it with POJO variable -->
